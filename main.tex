...
In this place I would like to thank the scientific staff of the Chair of Thermal Engineering of Poznań University of Technology, with special recognition to MSc. Eng. Bartosz Ziegler and PhD Eng. Przemysław Grzymisławski for thorough scientific and personal support during this project.
...
A big recognition goes to the owners and maintainers of the PLGRID - Polish HPC infrastructure, especially team in HPC Cyfronet center in AGH University of Science and Technology in Kraków. Being able to use the state of the art HPC clusters made this project possible.
...
\fancyhead[RE, LO]{\emph{Contents}} % Set the left side page header to "Contents"
\setcounter{tocdepth}{1}
\tableofcontents % Write out the Table of Contents

\fancyhead[RE, LO]{\emph{List of Figures}} % Set the left side page header to "List of Figures"
\listoffigures % Write out the List of Figures

\fancyhead[RE, LO]{\emph{List of Tables}} % Set the left side page header to "List of Tables"
...
\fancyhead[RE, LO]{\emph{Abbreviations}} % Set the left side page header to "Abbreviations"
...
\fancyhead[RE, LO] {\emph{Symbols}} % Set the left side page header to "Symbols"
...
\fancyhead[RE, LO]{\emph{Indices}} % Set the left side page header to "Symbols"
...
\dedicatory{To my Wife Inez for limitless patience\ldots} % Dedication text
...
\fancyhead[RE, LO]{\emph{Bibliography}} % Change the page header to say "Bibliography"
